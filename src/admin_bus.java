...
public class admin_bus extends javax.swing.JFrame {
    ...
    public admin_bus() throws SQLException {
        initComponents();
        this.conn = config.configDB();
        load_table();
    }
     protected void datatable(){
       Object[] Baris = {"ID_BUS","BUS"};
       ...
       try{
           ...
           while(hasil.next()){
               String id_bus = hasil.getString("ID_BUS");
               String bus= hasil.getString("BUS");
               
               
               
               String[] data = {id_bus,bus};
               tabmode.addRow(data);
           }
       }catch(Exception e){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "BUS", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        lblKode.setText("Kode Bus");

        lblMaskapai.setText("Nama Bus");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtBus, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tbl_bus.setBackground(new java.awt.Color(204, 204, 255));
        ...
        jPanel1.getAccessibleContext().setAccessibleName("bus");
    ...
    private void tbl_busMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_busMouseClicked
        ...
        int baris = tbl_bus.rowAtPoint(evt.getPoint());
        txtKode.setText(tbl_bus.getValueAt(baris, 0).toString());
        txtBus.setText(tbl_bus.getValueAt(baris, 1).toString());
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            ...
            stat.setString(2, txtBus.getText());
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        try{
            ...
            String sql = "update bus set BUS=?"
            + "where ID_BUS='"+txtKode.getText()+"'";

            PreparedStatement stat = conn.prepareStatement(sql);
            stat.setString(1, txtBus.getText());
            stat.executeUpdate();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if(ok==0){
            String sql = "delete from bus where ID_BUS = '"+txtKode.getText()+"'";
            try{
                PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void load_table() {
        ...
        try {
            String sql_kota = "SELECT * FROM bus";
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(admin_bus.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
